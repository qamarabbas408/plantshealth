        ...
        @if(isset($posts) && $posts->count() > 0)
            ...
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg bg-white hover:shadow-xl transition duration-300">
                <div class="flex-shrink-0 h-48 w-full bg-gray-100">
                    <img class="h-full w-full object-cover" src="{{ $imgSrc }}" alt="{{ $post->title }}">
                </div>
                ...
                <div class="flex-1 p-6 flex flex-col justify-between">
                    <div class="flex-1">
                        ...
                        <a href="{{ route('posts.show', ['username' => Str::slug($post->author->name), 'slug' => $post->slug]) }}"  class="block mt-2">
                    ...
                    <div class="mt-6 flex items-center">
                        <div class="flex-shrink-0">
                            ...
                            <span class="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-bold uppercase">
