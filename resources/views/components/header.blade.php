            ...
            <div class="flex">
                ...
                <div class="hidden sm:ms-10 sm:flex sm:space-x-8">
                    ...
                    <a href="{{ route('pages.about') }}"
                        class="{{ request()->routeIs('pages.about') ? 'border-brand-gold text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition duration-150 ease-in-out">
                        {{ __('About the Journal') }}
                    </a>

                    <!-- Editorial Board (Example: checks if route is 'editorial') -->
                    <a href="{{ route('pages.editorial') }}"
                        class="{{ request()->routeIs('pages.editorial') ? 'border-brand-gold text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition duration-150 ease-in-out">
                        {{ __('Editorial Board') }}
                    </a>
                </div>
            </div>
