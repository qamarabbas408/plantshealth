...
<head>
    ...
    <style>
        ...
        #sidebar-controls { transition: top 0.1s ease-out, opacity 0.2s ease; }
    </style>
</head>
<body class="bg-white text-gray-900 antialiased">
    ...
    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" id="storyForm">
        ...
        <div class="max-w-screen-xl mx-auto px-4 py-4 flex justify-between items-center sticky top-0 bg-white z-50">
            ...
            <button type="button" onclick="openModal()" class="bg-green-600 hover:bg-green-700 text-white text-sm px-4 py-1.5 rounded-full transition">
                Publish
            </button>
        </div>
        ...
        <div class="max-w-[700px] mx-auto px-4 mt-16 relative">
            ...
            <div class="relative group">
                ...
                <div id="sidebar-controls" class="absolute -left-14 z-20 flex items-center invisible opacity-0" style="top: 0px;">
                    ...
                    <button type="button" id="toggleBtn" onclick="toggleMenu()" 
                        ...
                        <!-- Plus Icon -->
                        <svg id="icon-plus" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                            <line x1="12" y1="5" x2="12" y2="19"></line>
                            <line x1="5" y1="12" x2="19" y2="12"></line>
                        </svg>

                        <!-- X Icon (Hidden) -->
                        <svg id="icon-close" class="hidden" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div id="sidebar-menu" class="hidden flex items-center gap-3 ml-3 bg-white">
                        ...
                        <!-- Image Button -->
                        <button type="button" onclick="document.getElementById('imageInsert').click()" class="rounded-full border border-green-600 text-green-600 w-8 h-8 flex items-center justify-center hover:bg-green-50 transition" title="Add Image">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg>
                        </button>

                        <!-- Code Button -->
                        <button type="button" onclick="insertCode()" class="rounded-full border border-green-600 text-green-600 w-8 h-8 flex items-center justify-center hover:bg-green-50 transition" title="Add Code Block">
        ...
        <div id="publishModal" class="fixed inset-0 bg-white z-[60] hidden overflow-y-auto">
            <div class="max-w-screen-xl mx-auto px-4 py-4 flex justify-end">
                <button type="button" onclick="closeModal()" class="text-3xl text-gray-400 hover:text-gray-800">&times;</button>
            </div>
            <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 mt-8 px-4">
                ...
                <div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-md border border-gray-100">
                        <div class="relative bg-gray-200 h-56 w-full mb-4 flex items-center justify-center cursor-pointer overflow-hidden group" onclick="document.getElementById('coverImage').click()">
                            <img id="modalPreview" class="absolute inset-0 w-full h-full object-cover hidden">
                            <span id="modalText" class="text-gray-400 text-sm group-hover:text-gray-600">Add a high-quality image...</span>
                        </div>
                        <input type="file" name="featured_image" id="coverImage" class="hidden" onchange="previewCover(this)">
                        
                        <h4 class="font-serif font-bold text-xl mb-2 text-gray-900" id="previewTitle">Untitled Story</h4>
                ...
                <div>
                    ...
                    <button type="submit" class="bg-green-600 text-white font-bold py-2 px-8 rounded-full hover:bg-green-700 transition">
                        Publish now
                    </button>
                </div>
            </div>
